...
比如线程0执行 mov  flag, %ax 完后，时钟中断，切到线程1执行，而线程1在执行 mov  %ax,count 中断，切到线程0，此时线程1是拥有锁的，线程0继续执行 test $0, %ax ,这时ax的值是0，因为线程有单独的寄存器，所以线程0也获得了锁。
...
![结果](D:/Documents/HNU课程/大三上/操作系统/Operating-Systems-Three-Easy-Pieces-NOTES/28.第二十八章-锁/5.png)
